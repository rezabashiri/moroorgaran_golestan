...
using Microsoft.Web.DynamicData.Handlers;

namespace Golestane_Shohada
{
    public partial class Image_Edit : FieldTemplateUserControl
    {

        protected void Page_Load(object sender, EventArgs e)
        {
            CustomValidator1.ServerValidate += CustomValidator1_ServerValidate;
        }
        ...
        void CustomValidator1_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            else
            {
                if (Column.IsRequired)
                {
                    ...
                    CustomValidator1.ErrorMessage = attribute.FormatErrorMessage(Column.DisplayName);
                    args.IsValid = false;
                }
            }
        }
